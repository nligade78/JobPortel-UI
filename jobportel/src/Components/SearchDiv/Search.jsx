    ...
    <div className='searchDiv grid gap-5 bg-greyIsh rounded-[10px] p-[3rem]'>
      <form action="">
        <div className='firstDiv flex justify-between items-center rounded-[8px] gap-[10px] bg-white p-5 shadow-lg shadow-greyIsh-700'>
          ...
          <div className='flex gap-2 items-center'>
            ...
            <AiFillCloseCircle className='text-[30px] text-[#a5a6a6] hover:text-textColor icon' />
          </div>

          <div className='flex gap-2 items-center'>
            <BsHouseAddFill className='text-[25px] icon' />
          ...
          <button className='bg-blueColor h-full p-25 px-10 rounded-[10px] text-white cursor-pointer hover:bg-blue-300'>Search</button>
        </div>
      ...
      <div className='secDiv flex items-center gap-10 justify-center'  >
        ...
        <div className='singleSearch flex items-center gap-2'>
          ...
          <select name="" id="type" className='bg-white rounded-[3px] px-3 py-1'>
        ...
        <div className='singleSearch flex items-center gap-2'>
          ...
          <select name="" id="level" className='bg-white rounded-[3px] px-3 py-1'>
